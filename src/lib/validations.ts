...
export const ContactFormSchema = z.object({
  ...
  company: z
    ...
    .or(z.literal('')),
  interest: z
    .enum(['custom-website', 'ai-integration', 'web-application', 'consultation'])
    .pipe(
      z
        .enum(['custom-website', 'ai-integration', 'web-application', 'consultation'])
        .refine((val) => val, { message: 'Please select an area of interest' }),
    ),
  message: z
    .string()
  ...
  budget: z.enum(['under-5k', '5k-15k', '15k-50k', 'over-50k']).optional().or(z.literal('')),
